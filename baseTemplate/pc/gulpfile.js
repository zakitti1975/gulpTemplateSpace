...
var root = './',
    ...
    // イメージセンター
    imagecenter = 'https://xxx.dummy.imagepass/' + directoryName + '/' + projectName + '/pc/',
 ...
 *******************************************/
 ...
 gulp.task('html', function () {
    ...
    return gulp
        ...
        .pipe(pug({pretty: '    '}))
        .pipe(htmlhint())
        .pipe(replace('index.css', projectName + '_pc.css'))
        .pipe(replace('index.js', projectName + '_pc.js'))
...
//        .pipe(replace('index.css', projectName + '_pc.min.css'))
//        .pipe(replace('index.js', projectName + '_pc.min.js'))
//        .pipe(check(/http:\/\//))
//        .on('error', function(){
...
gulp.task('css', function () {
    ...
    return gulp
        ...
        .pipe(rename(projectName +'_pc.css'))
...
gulp.task('js', function(){
    ...
    return gulp
        ...
        .pipe(plumber())
        .pipe(concat(projectName + '_pc.js'))
